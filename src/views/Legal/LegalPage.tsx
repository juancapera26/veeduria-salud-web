...
const policyContent = {
  treatment: {
    ...
    sections: [
      ["1. Responsable del tratamiento", "El responsable del tratamiento de los datos personales es VEESIPP Colombia, organización ciudadana dedicada a la vigilancia, participación y control social en salud.", "Canales de atención: veesipp@veesippcolombia.com, teléfono 300 218 6531 y dirección Avenida Ambalá, Colombia."],
