        ...
        <section className="section registration-section">
          <div className="page-wrap">
            ...
            <div className="registration-intro-grid">
              <Reveal className="event-summary" aria-labelledby="event-title">
              ...
              <VisualReveal className="registration-visual"><aside aria-label="Registro al Congreso de Salud Mental"><img src={registrationIllustration.src} alt="Persona completando un registro para el evento" /></aside></VisualReveal>
            </div>
            <Reveal><iframe
              ref={frameRef}
